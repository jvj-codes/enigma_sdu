...
4. EnigmaView.py	(Optional GUI) Visual representation of the Enigma machine: keyboard, lamps, rotors. Allows user to press keys, see which lamp lights up, and manually click rotors to change their settings. This is useful for interactive encryption/decryption as if using a physical Enigma.
...
1. Run the GUI simulator
    ...
    The rotors step automatically as in a real Enigma. You can also click rotor “wheels” to manually change offsets if implemented
